...
| UI-04 | pendiente | UI-02, IMP-29 | Llevar la UI productiva a fidelidad 1:1 con el Claude Blind Mockup usando únicamente datos canónicos reales disponibles, y producir un backlog explícito de todo dato/productor faltante. | OWNER REQUEST 24-sep-2026. Instrucción literal a Claude: “queremos que se vea nuestra página de User Interface uno a uno con el mockup que mandaste, rellena con los datos que tengamos y los que no tenemos o los que faltes nos haces una lista y ahí tenemos una lista como de to-do”. Restricción: cero datos demo/fabricados; cada valor visible debe tener productor/manifest canónico verificable. Si falta un dato, dejar la superficie honesta UNAVAILABLE/ERROR y registrar el TO-DO exacto con productor, input requerido, proceso/run necesario y criterio de cierre. |
