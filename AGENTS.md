# Energy Markets / Procurement Research — instrucciones para agentes
...
Las instrucciones anteriores (roles Paperclip, prohibición de commits) quedan en el historial de git, commit f545d86, y ya no aplican.
