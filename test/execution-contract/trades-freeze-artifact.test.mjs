...
// son jobs/decisión pendientes; los tests usan fixtures para probar el mecanismo.
...
import { approvalFor, measurementFixture } from "./trades-fixtures.mjs";
...
test("con medición pero sin aprobación publica el candidato y su configHash", () => {
  const { artifact } = buildTradesFreezeArtifact({
    ...
    sourceDecision: { brokenSpreadPolicy: "INCLUDE", measurements: { deleteTmSemantics: { value: "deletion-time" } } },
    ownerApproval: null,
