// Valida el ST_RECEIPT de ST-28.1 con los validadores aceptados de IMP-01
...
const receipt = JSON.parse(fs.readFileSync(new URL("../../../operations/receipts/IMP-28-ST-1.json", import.meta.url)));
